...
import com.servercommon.abstractclasses.GenericThreadPerClientTCPApplicationServer;

/**
 * @author Adrian
 *
 */
public class PriceCalculatorThreadPerClientTCPApplicationServer extends GenericThreadPerClientTCPApplicationServer {
	...
	public PriceCalculatorThreadPerClientTCPApplicationServer(int serverPort) {
		super(serverPort);
